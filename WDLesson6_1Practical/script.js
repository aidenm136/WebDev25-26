...
let meat_prices = [$8.99, $17.99, $12.99, $20.99];
...
function init(){
  ...
  */
  ...
  for(let i=0; i<meat_images.length; i++){
    build+=`<div class="card">
            <h3>${meat_titles[i]}</h3>
            <img class="title" src="images/${meat_images[i]}">
            <p>$${meat_prices[i]}</h4>
          </div>`;
  }
  m.innerHTML=build;
 ...
 for(let i=0; i<seafood_images.length; i++){
    build+=`<div class="card">
            ...
            <img class="title" src="images/${seafood_images[i]}">
            <p>$${seafood_prices[i]}</h4>
          </div>`;
  }
  s.innerHTML=build;    
 ...
 for(let i=0; i<dessert_images.length; i++){
    build+=`<div class="card">
            ...
            <img class="title" src="images/${dessert_images[i]}">
            <p>$${dessert_prices[i]}</h4>
          </div>`;
  }
  d.innerHTML=build;
}
